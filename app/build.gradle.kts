...
// Retrofit Coroutine adapter
    implementation(libs.adapter.rxjava2) // Add this if you plan to use RxJava; otherwise, use Retrofit2's default Coroutine support
    ...
    implementation (libs.logging.interceptor.v4100)// Make sure to use the latest version
